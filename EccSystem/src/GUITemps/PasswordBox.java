...
public class PasswordBox extends JPasswordField {
	public PasswordBox(String placeholder) throws FontFormatException, IOException{
		...
		addMouseListener(new MouseAdapter() {
			...
			public void mouseExited(MouseEvent e) {
				if(new String(getPassword()).equals(placeholder)||new String(getPassword()).equals("")) {
					setText(placeholder);
					setEchoChar((char) 0);
				}
			}
